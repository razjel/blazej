...
package com.junkbyte.console 
{
	...
	public class Console extends Sprite {
		 ...
		 */
		public function map(container:DisplayObjectContainer, maxstep:uint = 0, props:Array = null):void{
			_tools.map(container, maxstep, DEFAULT_CHANNEL, props);
		}
		
		/**
		 * @copy com.junkbyte.console.Cc#mapch()
		 */
		public function mapch(channel:*, container:DisplayObjectContainer, maxstep:uint = 0, props:Array = null):void{
			_tools.map(container, maxstep, MakeChannelName(channel), props);
		}
		public function mapche(channel:*, container:DisplayObjectContainer, maxstep:uint = 0, props:Array = null):void{
			_tools.mape(container, maxstep, MakeChannelName(channel), props);
		}
