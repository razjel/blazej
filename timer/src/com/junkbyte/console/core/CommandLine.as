...
package com.junkbyte.console.core 
{
	...
	public class CommandLine extends ConsoleCore{
		...
		public function CommandLine(m:Console) {
			...
			addCLCmd("mape", mapCmde, "Get display list map starting from current scope, use Element isntead of children");
		...
		private function mapCmd(param:String = "0"):void{
			console.mapch(console.panels.mainPanel.reportChannel, _scope as DisplayObjectContainer, 0, param.split(" "));
		}
		private function mapCmde(param:String = "0"):void{
			console.mapche(console.panels.mainPanel.reportChannel, _scope as DisplayObjectContainer, 0, param.split(" "));
		}
		...
		// ==============================================================
		// This part of class is not an original piece of code, it is added to allow for creation of more
		// robust custom slashCommands.
		// ==============================================================
		...
		public function restore(name:String):*
		{
