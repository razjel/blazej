...
*
* REQUIRES Flash Player 11.0 OR by.blooddy.crypto.serialization.JSON
*/
package com.junkbyte.console.addons.htmlexport
{
	 ...
	 * </ul>
	 *
	 * REQUIRES Flash Player 11.0 OR by.blooddy.crypto.serialization.JSON newlibrary.
	 */
	public class ConsoleHtmlExportAddon
	{
		...
		protected function exportJSON():String
		{
			...
			var libJSON:Class = getDefinitionByName("by.blooddy.crypto.serialization.JSON") as Class;
